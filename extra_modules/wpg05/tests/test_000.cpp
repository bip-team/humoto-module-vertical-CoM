...
int main()
{
    ...
    try
    {
        std::string config_file_name = "extra_modules/wpg05/tests/test_000.yaml";
        ...
        humoto::wpg05::Model model;
        humoto::wpg05::ModelState model_state;

        // control problem, which is used to construct an optimization problem
        humoto::wpg05::SimpleMPC simpleMPC(problem_parameters);
